...
if (isset($_POST['txtUsername'])) {
    ...
    $query = "SELECT * FROM tbl_patients WHERE Username = '" . $email . "' and Password = '" . $encPwd . "'";
    
    $result = mysqli_query($conn, $query);
    if ($row = mysqli_fetch_array($result)) {
        $_SESSION['patient_uid'] = $row['LoginId'];
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="../index.php"><img class="logo-img" src="../assets/img/logo/logo-blue.png" alt="logo" width="150px"></a><span class="splash-description">patientistrative Portal</span></div>
            <div class="card-body">
