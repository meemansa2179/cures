...
<?php
$_SESSION['sess_active_nav'] = "index"; 
?>
<body>
  <div class="hero_area">
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="row">
                <div class="col-md-6">
                  <div class="detail-box">
                    <div>
                      ...
                      <p>
                        Providing advanced, compassionate, and personalized cancer treatment, empowering every patient on their journey to healing and recovery.
                      </p>
                      <a href="">
                        Read More
                      </a>
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="front/images/link1.png" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="carousel-item ">
            <div class="container">
              <div class="row">
                <div class="col-md-6">
                  <div class="detail-box">
                    <div>
                      ...
                      <p>
                        Offering comprehensive mental health support, available both at our cancer hospital and online, to guide you through every step of your journey.
                      </p>
                      <a href="">
                        Read More
                      </a>
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="front/images/3656704-1.png" alt="">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="detail-box">
                    <div>
                      <h1>
                        health reports made easy!
                      </h1>
                      <p>
                        Access easy-to-understand health reports with the convenience to connect directly with your oncologists online for personalized guidance.
                      </p>
                      <a href="">
                        Read More
                      </a>
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img src="front/images/slide1.png" alt="">
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="about_section layout_padding">
    <div class="container">
      ...
      <div class="col-md-9 mx-auto px-0">
        <div class="detail-box">
          <p>
            Welcome to CURES Cancer Hospital and Online Support, where we are dedicated to providing exceptional, patient-centered care. Our state-of-the-art facility combines cutting-edge technology with a compassionate approach, ensuring that each patient receives personalized treatment tailored to their unique needs. With a team of highly skilled physicians, advanced treatment options, and a commitment to holistic well-being, we strive to make every patient's journey toward health and recovery as seamless and supportive as possible. Whether in person or online, we are here for you every step of the way.  
          </p>
          <a href="">
            Read More
          </a>
  ...
  <section class="service_section layout_padding-bottom">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p>
          This treatment center provides large range of cancer support treatment facility and services to improve health.
        </p>
      </div>
      <div class="row">
        ...
        <div class="col-md-4 mx-auto">
          <div class="box">
            <img src="front/images/s5.png" alt="" />
            <a href="#">
              Immunotherapy
            </a>
          </div>
