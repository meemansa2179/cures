...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="../front/images/favicon.png">
    <style>
    html,
    body {
        height: 100%;
...
<body>
    ...
    <div class="splash-container">
        <div class="card">
            <div class="card-header text-center"><img class="logo-img" src="../front/images/logo2.png"  width="150px" alt="logo"><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
                <form>
